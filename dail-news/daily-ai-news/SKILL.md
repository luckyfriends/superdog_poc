...
将数据填入模板，**用 Write 工具保存为** `~/Documents/temp/daily-ai-news-{YYYY-MM-DD}.html`
...
```
~/Documents/temp/daily-ai-news-{YYYY-MM-DD}.html
```
完成后告知：**"已生成 → ~/Documents/temp/daily-ai-news-YYYY-MM-DD.html，浏览器打开即可。共 N 条，去重后独立事件。"**
